...
from scripts.extract.google_extract import extract_google_data
from scripts.load.google_load import load_google_data
...
extract_task = PythonOperator(
    ...
    python_callable=extract_google_data,   # ✅ 실행할 Python 함수
...
load_task = PythonOperator(
    ...
    python_callable=load_google_data, # ✅ 실행할 Python 함수
    provide_context=True,   # ✅ XCom을 가져오도록 설정
    dag=dag,    # ✅ 해당 DAG에 연결
)
